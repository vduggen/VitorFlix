  ...
  return (
    <>
      ...
      <Banner
        ...
        videoDescription={"O que é Front-end? Trabalhando na área os termos HTML, CSS e Javascript fazem parte da rotina das desenvolvedoras e desenvolvedore. Mas o que eles fazem, afinal? Descubra com a Vanessa!"}
      />

      <Carousel
        ignoreFirstVideo
        category={Datas.categorias[0]}
      />
